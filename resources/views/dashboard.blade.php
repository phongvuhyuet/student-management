                                                                ...
                                                                <div class="col-md-10 ">
                                                                    <div class="table-responsive mb-3 mb-md-0 mt-3">
                                                                        <table class="table table-borderless report-table">
                                                                            <tr>
                                                                                @php
                                                                                    ...
                                                                                    foreach ($studentss as $student) {
                                                                                      ...
                                                                                      if ($student->GPA >= 3.6) {
                                                                                            $countXs++;
                                                                                        } elseif ($student->GPA >= 3.2) {
                                                                                            $countG++;
                                                                                        } elseif ($student->GPA >= 2.5) {
                                                                                            $countK++;
                                                                                        }
                                                                                      $totalMoney = 300000 * $student->so_TC;
                                                                                      $paidMoney = $totalMoney - $student->hocPhiChuaNop;
                                                                                  ...
                                                                                  //   }
                                                                                    ...
                                                                                    $great_attitude =$studentss
                                                                                        ->where('diem_chuyen_can', '>=', 80)
                                                                                        ->count();
                                                                                    $remind_count =$studentss
                                                                                        ->where('so_lan_nhac_nho', '>', 0)
                                                                                        ->count();
                                                                                    $warn_count =$studentss
                                                                                  ...
                                                                                  //   }
                                                                                @endphp
                                                                                <td class="text-muted">Số lượng sinh viên
                                                                                    suất
                                                                                    sắc
                                                                                </td>
                                                                                <td class="w-100 px-0">
                                                                            ...
                                                                            <tr>
                                                                                <td class="text-muted">Sinh viên có điểm
                                                                                    rèn
                                                                                    luyện
                                                                                    tốt</td>
                                                                                <td class="w-100 px-0">
                                                                            ...
                                                                            <tr>
                                                                                <td class="text-muted">Sinh viên bị nhắc
                                                                                    nhở
                                                                                </td>
                                                                                <td class="w-100 px-0">
                                                                                    <div class="progress progress-md mx-4">
                                                                            ...
                                                                            <tr>
                                                                                <td class="text-muted">Sinh viên bị cảnh
                                                                                    báo
                                                                                </td>
                                                                                <td class="w-100 px-0">
                                                                                    <div class="progress progress-md mx-4">
                                                                            ...
                                                                            <tr>
                                                                                <td class="text-muted">Sinh viên nợ học
                                                                                    phí
                                                                                </td>
                                                                                <td class="w-100 px-0">
                                                                                    <div class="progress progress-md mx-4">
